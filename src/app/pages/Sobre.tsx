  ...
  return (
    <div className="min-h-screen bg-[#0b0b0b] text-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <p className="font-['Archivo',sans-serif] font-extrabold text-[11px] tracking-[0.3em] text-[#22ff88] mb-3">
          A PELADA
        </p>
        ...
        <div className="mt-12 p-6 rounded-2xl border border-white/[0.06] bg-white/[0.02]">
          <h3 className="font-['Archivo',sans-serif] font-extrabold text-lg mb-2">Tipos de pelada</h3>
