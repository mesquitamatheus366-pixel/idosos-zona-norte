...
interface MarcoAssistenciasCardProps {
  playerName: string;
  playerNumber: number;
  playerPhoto?: string;
  total: number;
...
export function MarcoAssistenciasCard({ playerName, playerNumber, playerPhoto, total, milestone }: MarcoAssistenciasCardProps) {
  return (
